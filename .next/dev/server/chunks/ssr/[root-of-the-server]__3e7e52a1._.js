...
"[project]/src/app/(app)/tickets/new/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module '../NewTicketClient'");
...
async function Page() {
    ...
    const devices = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].device.findMany({
        orderBy: {
            name: 'asc'
        }
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(NewTicketClient, {
        customers: customers,
        devices: devices
    }, void 0, false, {
        fileName: "[project]/src/app/(app)/tickets/new/page.tsx",
        lineNumber: 8,
        columnNumber: 10
    }, this);
}
...
"[project]/src/app/(app)/tickets/new/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/(app)/tickets/new/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__3e7e52a1._.js.map